                ...
                <div class="user-card" style="width: 250px">
                    <div class="row">
                        ...
                        <div>
                            ...
                            <p><a href="https://bubble-af31447.slack.com/messages/DJ09UN28Z/" target="_blank"><img src="https://a.slack-edge.com/4f28/img/services/api_200.png" style="height:16px; width:16px; margin:-2px 0 ">&nbsp;<strong>@${user.name.first}.${user.name.last}</strong></a></p>
